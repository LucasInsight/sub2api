export default {
  ...
  auth: {
    ...
    oauthOnlyRegistration: '当前仅支持通过第三方 OAuth 方式注册，请选择下方登录方式继续。',
    oauthOnlyRegistrationNoProvider: '当前仅支持通过第三方 OAuth 方式注册，暂无可用登录方式，请稍后再试。',
    emailLabel: '邮箱',
  ...
  usage: {
    ...
    userBilled: '用户扣费',
    accountBilled: '账号计费',
    quotaEstimateTooltip: '估算总额度 = 当前窗口账号计费 / 上游使用率',
    quotaEstimateTooltipSource: '范围来自当前最高可信使用率覆盖层',
    quotaEstimateCurrentPeriod: '本重置周期',
    quotaEstimatePreviousPeriodTitle: '上一个重置周期',
    quotaEstimateMinMax: '估算范围 min {min} / max {max}',
    quotaEstimateCoverage: '覆盖层 {from}%-{to}%',
    quotaEstimateUpdatedAt: '更新时间 {time}',
    quotaEstimatePeriodEndedAt: '结束时间 {time}',
    quotaEstimatePreviousMinMax: '上一周期估算范围 min {min} / max {max}',
    quotaEstimatePreviousCoverage: '上一周期覆盖层 {from}%-{to}%',
    quotaEstimatePreviousPeriod: '上一周期结束 {time}',
    quotaEstimatePreviousUpdatedAt: '上一周期更新时间 {time}',
    resetNow: '现在',
    resetPending: '待刷新',
  ...
  admin: {
    ...
    settings: {
      ...
      registration: {
        ...
        oauthOnly: '仅允许第三方登录注册',
        oauthOnlyHint: '开启后，邮箱密码注册入口将关闭，新用户只能通过已启用的第三方登录创建账户',
