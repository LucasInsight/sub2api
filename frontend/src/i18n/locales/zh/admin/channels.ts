export default {
    ...
    subscriptions: {
      ...
      resetAllQuotaConfirm: '请确认已核实本次 OpenAI 7 天配额提前重置的来源。继续重置全部 {count} 个有效订阅的 5 小时、每日、每周和每月配额吗？此操作不可撤销。',
      resetAllQuotaSuccess: '已重置 {count} 个有效订阅的配额',
      failedToResetAllQuota: '重置全部订阅配额失败',
      checkingResetAllQuota: '正在检查官方 7 天配额状态',
      resettingAllQuota: '正在重置全部订阅配额',
      resetAllQuotaLocked: '仅在检测到 OpenAI 7 天配额提前重置后可用，重置来源由管理员确认',
