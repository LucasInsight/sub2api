export default {
  ...
  auth: {
    ...
    oauthOnlyRegistration: 'Registration is only available through third-party OAuth. Choose a sign-in method below to continue.',
    oauthOnlyRegistrationNoProvider: 'Registration is only available through third-party OAuth. No sign-in method is available yet. Please try again later.',
    emailLabel: 'Email',
  ...
  usage: {
    ...
    quotaEstimateTooltip: 'Estimated total quota = current window account cost / upstream usage percentage',
    quotaEstimateTooltipSource: 'Range comes from the current highest-confidence usage coverage bucket',
    quotaEstimateCurrentPeriod: 'Current reset period',
    quotaEstimatePreviousPeriodTitle: 'Previous reset period',
    quotaEstimateMinMax: 'Estimated range min {min} / max {max}',
    quotaEstimateCoverage: 'Coverage {from}%-{to}%',
    quotaEstimateUpdatedAt: 'Updated at {time}',
    quotaEstimatePeriodEndedAt: 'Ended at {time}',
    quotaEstimatePreviousMinMax: 'Previous period range min {min} / max {max}',
    quotaEstimatePreviousCoverage: 'Previous period coverage {from}%-{to}%',
    quotaEstimatePreviousPeriod: 'Previous period ended at {time}',
    quotaEstimatePreviousUpdatedAt: 'Previous period updated at {time}',
    resetNow: 'Now',
  ...
  admin: {
    ...
    settings: {
      ...
      registration: {
        ...
        oauthOnly: 'Third-party login registration only',
        oauthOnlyHint: 'Disable email/password signup so new users can only create accounts through enabled third-party login methods',
