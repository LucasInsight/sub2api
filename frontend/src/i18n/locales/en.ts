export default {
  ...
  usage: {
    ...
    quotaEstimateTooltip: 'Estimated total quota = current window account cost / upstream usage percentage. Range comes from the current highest-confidence usage coverage bucket.',
