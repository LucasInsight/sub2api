export default {
    ...
    subscriptions: {
      ...
      upgrade: 'Upgrade',
      upgrading: 'Upgrading...',
      upgradeSource: 'Current subscription',
      upgradeTarget: 'Target subscription group',
      upgradeUsage: 'Current usage to carry over',
      selectUpgradeTarget: 'Select target subscription group',
      noUpgradeTargets: 'No eligible same-platform subscription groups',
      upgradeWarning: 'The current usage, usage windows, and expiration will carry over. The source subscription will be revoked and its API keys will move to the target group.',
      restore: 'Restore',
      resetQuota: 'Reset Quota',
      resetQuotaTitle: 'Reset Usage Quota',
      resetQuotaConfirm: "Reset the 5-hour, daily, weekly, and monthly usage quota for '{user}'? Usage will be zeroed and windows restarted.",
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      resetAllQuota: 'Reset All Quotas',
      resetAllQuotaTitle: 'Reset All Subscription Quotas',
      resetAllQuotaConfirm: 'Reset the 5-hour, daily, weekly, and monthly quotas for all {count} active subscriptions? This action cannot be undone.',
      resetAllQuotaAcknowledgement: 'I confirm that OpenAI has officially reset the quota',
      resetAllQuotaSuccess: 'Reset quotas for {count} active subscriptions',
      failedToResetAllQuota: 'Failed to reset all subscription quotas',
      checkingResetAllQuota: 'Checking reset-all availability',
      resettingAllQuota: 'Resetting all subscription quotas',
      resetAllQuotaLocked: 'Resetting all quotas is currently unavailable',
      resetAllQuotaNoActive: 'There are no active subscriptions to reset',
      resetAllQuotaReady: 'Reset {count} active subscriptions',
      ...
      clearFalsePositiveTitle: 'Clear Early-reset False Positive',
      clearFalsePositiveConfirm: 'Only the selected pending marker will be cleared. Subscription quotas will not be reset, and existing audit logs will be retained.',
      clearFalsePositiveAccount: 'Pending event',
      clearFalsePositiveOption: '{account} · detected at {time}',
      clearFalsePositiveDescription: 'Clear a false-positive marker for one account without resetting subscription quotas',
      clearFalsePositiveNoPending: 'There are no pending early-reset events to clear',
      clearingFalsePositive: 'Clearing false-positive marker',
      clearFalsePositiveSuccess: 'Cleared the false-positive marker for {account}',
      failedToClearFalsePositive: 'Failed to clear the false-positive marker; refresh and try again',
      ...
      failedToUpgrade: 'Failed to upgrade subscription',
      failedToLoadUpgradeTargets: 'Failed to load upgrade targets',
      errors: {
        SUBSCRIPTION_UPGRADE_SOURCE_INVALID: 'The source subscription must be active and unexpired',
        SUBSCRIPTION_UPGRADE_SAME_GROUP: 'The target group must differ from the current group',
        SUBSCRIPTION_UPGRADE_TARGET_INACTIVE: 'The target group is inactive',
        SUBSCRIPTION_UPGRADE_PLATFORM_MISMATCH: 'The target group must use the same platform as the current group',
        SUBSCRIPTION_UPGRADE_TARGET_EXISTS: 'The user already has a subscription for the target group',
        GROUP_NOT_SUBSCRIPTION_TYPE: 'The target group is not a subscription group'
      },
      ...
      guide: {
        ...
        subtitle: 'Subscription mode lets you assign time-based usage quotas to users, with 5-hour/daily/weekly/monthly limits. Follow these steps to get started.',
        showGuide: 'Usage Guide',
        step1: {
          title: 'Create a Subscription Group',
          line1: 'Go to "Group Management" page, click "Create Group"',
          line2: 'Set billing type to "Subscription", configure 5-hour/daily/weekly/monthly quota limits',
        ...
        actions: {
          ...
          resetQuota: 'Reset Quota',
          resetQuotaDesc: 'Reset 5-hour/daily/weekly/monthly usage to zero',
          revoke: 'Revoke',
