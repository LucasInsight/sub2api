export default {
    ...
    subscriptions: {
      ...
      resetAllQuotaConfirm: 'Confirm that you have verified the source of this OpenAI 7-day early reset. Reset the 5-hour, daily, weekly, and monthly quotas for all {count} active subscriptions? This action cannot be undone.',
      ...
      checkingResetAllQuota: 'Checking the official 7-day quota status',
      resettingAllQuota: 'Resetting all subscription quotas',
      resetAllQuotaLocked: 'Available after an OpenAI 7-day early reset is detected; the administrator verifies its source',
