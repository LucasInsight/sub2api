...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subscriptionService := service.ProvideSubscriptionService(groupRepository, userSubscriptionRepository, apiKeyRepository, billingCacheService, apiKeyAuthCacheInvalidator, client, configConfig)
