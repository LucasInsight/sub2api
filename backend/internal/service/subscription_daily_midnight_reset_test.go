...
func (r *dailyMidnightResetRepo) ActivateFiveHourWindow(context.Context, int64, time.Time) error {
	return nil
}

func (r *dailyMidnightResetRepo) ResetFiveHourUsage(context.Context, int64, time.Time) error {
	return nil
}
