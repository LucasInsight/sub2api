...
func (r *monthlyResetUserSubRepo) ActivateFiveHourWindow(context.Context, int64, time.Time) error {
	return nil
}

func (r *monthlyResetUserSubRepo) ResetFiveHourUsage(context.Context, int64, time.Time) error {
	return nil
}
