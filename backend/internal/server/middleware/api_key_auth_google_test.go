...
func (f fakeGoogleSubscriptionRepo) ActivateWindows(ctx context.Context, id int64, _ time.Time, calendarWindowStart time.Time) error {
	if f.activateWindow != nil {
		return f.activateWindow(ctx, id, calendarWindowStart)
	}
	return errors.New("not implemented")
}
func (f fakeGoogleSubscriptionRepo) ActivateFiveHourWindow(ctx context.Context, id int64, start time.Time) error {
	if f.activateWindow != nil {
