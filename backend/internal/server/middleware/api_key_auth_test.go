...
func (r *stubUserSubscriptionRepo) ActivateWindows(ctx context.Context, id int64, _ time.Time, calendarWindowStart time.Time) error {
...
func (r *stubUserSubscriptionRepo) ActivateFiveHourWindow(ctx context.Context, id int64, start time.Time) error {
	if r.activateWindow != nil {
